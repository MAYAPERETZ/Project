...
abstract class AbstractBlockTable<T> {
	...
	Number baseAddress, limitAddress, baseSegmentAddress;
	static final int BLOCK_LENGTH_ADDRESS = 1024;  // allocated blocksize 1024 ints == 4K Numbers
	T [][] blockTable;
	final Number defaultLimitAddress;

	AbstractBlockTable(int tableLen, Number baseAddress) {
	...
	/**
	* Handy utility to find out if given address is in a specified segment area
